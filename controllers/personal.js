...
const postPersonal = async (req = request, res = response) => {
    ...
    const { dpi, nombre, apellido, fechaNacimiento, fechaContratacion, telefono, correo, fechaBaja, estado, puesto } = req.body;
    const personalDB = new Personal({ dpi, nombre, apellido, fechaNacimiento, fechaContratacion, telefono, correo, fechaBaja, estado, puesto });
